...
private:
  ...
  GBWaypoint* takeout_waypoint(int lat_e7, int lon_e7, const QString* shortname, const QString* description, const QString* start_str);
  static bool track_maybe_add_wpt(route_head* route, GBWaypoint* waypoint);
