...
private:
  ...
  static QString ozi_get_time_str(const GBWaypoint* waypointp);
  static void ozi_set_time_str(const QString& str, GBWaypoint* waypointp);
  void ozi_convert_datum(GBWaypoint* wpt) const;
  void ozi_openfile(const QString& fname);
  void ozi_track_hdr(const route_head* rte);
  void ozi_track_disp(const GBWaypoint* waypointp);
  void ozi_track_pr();
  void ozi_route_hdr(const route_head* rte);
  void ozi_route_disp(const GBWaypoint* waypointp);
  void ozi_route_pr();
  void ozi_init_units(int direction);
  void ozi_parse_waypt(int field, const QString& str, GBWaypoint* wpt_tmp, ozi_fsdata* fsdata) const;
  void ozi_parse_track(int field, const QString& str, GBWaypoint* wpt_tmp, char* trk_name);
  static void ozi_parse_routepoint(int field, const QString& str, GBWaypoint* wpt_tmp);
  void ozi_parse_routeheader(int field, const QString& str);
  void ozi_waypt_pr(const GBWaypoint* wpt, int index);
