...
private:
  ...
  static void tag_garmin_fs(tag_type tag, const QString& text, GBWaypoint* waypt);
  ...
  void write_gpx_url(const GBWaypoint* waypointp) const;
  void write_gpx_url(const route_head* rh) const;
  void gpx_write_common_acc(const GBWaypoint* waypointp, const gpx_wpt_fsdata* fs_gpxwpt) const;
  void gpx_write_common_position(const GBWaypoint* waypointp, gpx_point_type point_type, const gpx_wpt_fsdata* fs_gpxwpt) const;
  void gpx_write_common_extensions(const GBWaypoint* waypointp, gpx_point_type point_type) const;
  void gpx_write_common_description(const GBWaypoint* waypointp, gpx_point_type point_type, const gpx_wpt_fsdata* fs_gpxwpt) const;
  void gpx_waypt_pr(const GBWaypoint* waypointp) const;
  void gpx_write_common_core(const GBWaypoint* waypointp, gpx_point_type point_type) const;
  void gpx_track_hdr(const route_head* rte);
  void gpx_track_disp(const GBWaypoint* waypointp) const;
  void gpx_track_tlr(const route_head* unused);
  void gpx_track_pr();
  void gpx_route_hdr(const route_head* rte) const;
  void gpx_route_disp(const GBWaypoint* waypointp) const;
  void gpx_route_tlr(const route_head* unused) const;
  void gpx_route_pr();
  void gpx_waypt_bound_calc(const GBWaypoint* waypointp);
