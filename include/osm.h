...
private:
  ...
  void osm_disp_feature(const GBWaypoint* waypoint) const;
  void osm_write_opt_tag(const QString& atag);
  static void osm_release_ids(const GBWaypoint* waypoint);
  static QString osm_name_from_wpt(const GBWaypoint* waypoint);
  void osm_waypt_disp(const GBWaypoint* waypoint);
  void osm_rte_disp_head(const route_head* route);
  void osm_rtept_disp(const GBWaypoint* wpt_ref) const;
  ...
  QHash<QString, const GBWaypoint*> waypoints;
