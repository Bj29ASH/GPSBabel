...
private:
  ...
  static bool sort_comp_wpt_by_description(const GBWaypoint* a, const GBWaypoint* b);
  static bool sort_comp_wpt_by_gcid(const GBWaypoint* a, const GBWaypoint* b);
  static bool sort_comp_wpt_by_shortname(const GBWaypoint* a, const GBWaypoint* b);
  static bool sort_comp_wpt_by_time(const GBWaypoint* a, const GBWaypoint* b);
