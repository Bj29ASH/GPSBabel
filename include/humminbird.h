...
private:
  ...
  void humminbird_write_rtept(const GBWaypoint* wpt) const;
  void humminbird_write_waypoint(const GBWaypoint* wpt);
  void humminbird_write_waypoint_wrapper(const GBWaypoint* wpt);
...
private:
  ...
  void humminbird_track_cb(const GBWaypoint* wpt);
