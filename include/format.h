...
// track_disp_all(head, tail, trkpt);
  ...
  virtual GBWaypoint* rd_position(posn_status* /* status */)
  {
    return nullptr;
  }
  ...
  virtual void wr_position(GBWaypoint* /* wpt */)
  {
...
protected:
  ...
  {
  public:
    using WayptCb = void (MyFormat::*)(const GBWaypoint*);
    WayptFunctor(MyFormat* obj, WayptCb cb) : that(obj), _cb(cb) {}
    void operator()(const GBWaypoint* wpt)
    {
      ((that)->*(_cb))(wpt);
    }
