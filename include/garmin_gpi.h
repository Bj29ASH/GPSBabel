...
private:
  ...
  static garmin_fs_t* gpi_gmsd_init(GBWaypoint* wpt);
  ...
  int read_tag(const char* caller, int tag, GBWaypoint* wpt);
  void write_string(const QByteArray& str, char long_format) const;
  static bool compare_wpt_cb(const GBWaypoint* a, const GBWaypoint* b);
  ...
  static void wdata_add_wpt(writer_data_t* data, GBWaypoint* wpt);
  ...
  void enum_waypt_cb(const GBWaypoint* ref) const;
