...
private:
  ...
  static bool trackfilter_merge_sort_cb(const GBWaypoint* wa, const GBWaypoint* wb);
  ...
  static bool trackfilter_points_are_same(const GBWaypoint* wpta, const GBWaypoint* wptb);
