...
private:
  ...
  [[noreturn]] void unicsv_fatal_outside(const GBWaypoint* wpt) const;
  void unicsv_print_str(const QString& s) const;
  void unicsv_print_date_time(const QDateTime& idt) const;
  void unicsv_waypt_enum_cb(const GBWaypoint* wpt);
  void unicsv_waypt_disp_cb(const GBWaypoint* wpt);
