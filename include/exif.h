...
private:
  ...
  GBWaypoint* exif_waypt_from_exif_app(ExifApp* app) const;
  ...
  void exif_find_wpt_by_time(const GBWaypoint* wpt);
  void exif_find_wpt_by_name(const GBWaypoint* wpt);
