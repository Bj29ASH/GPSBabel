...
//  { 10016,    "Geocache Found" },      /* exclamation */
  ...
  static bool same_points(const GBWaypoint* A, const GBWaypoint* B);
  void register_waypt(const GBWaypoint* wpt) const;
  static const GBWaypoint* lowranceusr4_find_waypt(uint uid_unit, int uid_seq_low, int uid_seq_high);
  static const GBWaypoint* lowranceusr4_find_global_waypt(uint id1, uint id2, uint id3, uint id4);
  ...
  void lowranceusr_parse_waypt(GBWaypoint* wpt_tmp, int object_num_present) const;
  void lowranceusr4_parse_waypt(GBWaypoint* wpt_tmp) const;
  ...
  void lowranceusr_waypt_disp(const GBWaypoint* wpt) const;
  void lowranceusr4_waypt_disp(const GBWaypoint* wpt);
  void lowranceusr_waypt_pr(const GBWaypoint* wpt);
  void lowranceusr4_write_waypoints();
  void lowranceusr_write_icon(const GBWaypoint* wpt) const;
  ...
  void lowranceusr4_route_leg_disp(const GBWaypoint* wpt) const;
  void lowranceusr4_route_trl(const route_head* /*unused*/) const;
  void lowranceusr_trail_disp(const GBWaypoint* wpt);
  ...
  void lowranceusr4_trail_disp(const GBWaypoint* wpt) const;
  ...
  QList<const GBWaypoint*>* waypt_table{nullptr};
