...
public:
  ...
  void wr_position(GBWaypoint* wpt) override;
...
private:
  ...
  void kml_output_timestamp(const GBWaypoint* waypointp) const;
  ...
  static bool kml_altitude_known(const GBWaypoint* waypoint);
  void kml_write_coordinates(const GBWaypoint* waypointp) const;
  void kml_output_lookat(const GBWaypoint* waypointp) const;
  void kml_output_positioning(bool tessellate) const;
  void kml_output_description(const GBWaypoint* pt) const;
  void kml_recompute_time_bounds(const GBWaypoint* waypointp);
  void kml_add_to_bounds(const GBWaypoint* waypointp);
  void kml_output_point(const GBWaypoint* waypointp, kml_point_type pt_type) const;
  ...
  static QString kml_lookup_gc_icon(const GBWaypoint* waypointp);
  static const char* kml_lookup_gc_container(const GBWaypoint* waypointp);
  static QString kml_gc_mkstar(int rating);
  static QString kml_geocache_get_logs(const GBWaypoint* wpt);
  ...
  void kml_geocache_pr(const GBWaypoint* waypointp) const;
  void kml_waypt_pr(const GBWaypoint* waypointp) const;
  void kml_track_hdr(const route_head* header) const;
  void kml_track_disp(const GBWaypoint* waypointp) const;
  ...
  void kml_route_disp(const GBWaypoint* waypointp) const;
